...
for(var i in formData)formData[i]&&-1==$.inArray(i,['_csrf','action'])||delete formData[i];params.data={},params.data.sourceRecordData=formData,'QuickCreate'===thisInstance.formElement.attr('name')&&(params.isFromQuickCreate=!0);var referenceModuleName=this.getReferencedModuleName(container);App.Components.QuickCreate.createRecord(referenceModuleName,params);},/**
